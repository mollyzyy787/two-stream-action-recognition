...
def main():
    ...
    #Prepare DataLoader
    data_loader = dataloader.Motion_Pose_DataLoader(
                        BATCH_SIZE=arg.batch_size,
                        num_workers=8,
                        path='/home/molly/UCF_data/pose_flow/',
...
class Motion_CNN():
    ...
    def build_model(self):
        ...
        print(self.model)
        summary(self.model.cuda(), (30, 224, 224))
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            if is_best:
                ...
                with open('record/motion_pose/motion_pose_video_preds.pickle','wb') as f:
            ...
            },is_best,'record/motion_pose/checkpoint.pth.tar','record/motion_pose/model_best.pth.tar')
    ...
    def train_1epoch(self):
        ...
        for i, (data,label) in enumerate(progress):
            ...
            prec1, prec5 = accuracy(output.data, label, topk=(1, 3))
        ...
        info = {'Epoch':[self.epoch],
                ...
                'Loss':[np.round(losses.avg.cpu().numpy(),decimals = 5)],
                'Prec@1':[np.round(top1.avg.cpu().numpy(),decimals = 4)],
                'Prec@3':[np.round(top5.avg.cpu().numpy(),decimals = 4)],
                'lr': self.optimizer.param_groups[0]['lr']
                }
        record_info(info, 'record/motion_pose/posef_train.csv','train')
    ...
    def validate_1epoch(self):
        ...
        info = {'Epoch':[self.epoch],
                'Batch Time':[round(batch_time.avg,3)],
                'Loss':[np.round(video_loss,decimals = 5)],
                'Prec@1':[np.round(video_top1,decimals = 3)],
                'Prec@3':[np.round(video_top5,decimals = 3)]
                }
        record_info(info, 'record/motion_pose/posef_test.csv','test')
    ...
    def frame2_video_level_accuracy(self):
        ...
        video_level_preds = np.zeros((len(self.dic_video_level_preds),15))
