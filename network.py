...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, nb_classes=15, channel=20):
        self.inplanes = 64
...
def resnet18(pretrained=False, channel= 20, **kwargs):
    ...
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], nb_classes=15, channel=channel, **kwargs)
    if pretrained:
...
def resnet34(pretrained=False, channel= 20, **kwargs):
    ...
    model = ResNet(BasicBlock, [3, 4, 6, 3], nb_classes=15, channel=channel, **kwargs)
    if pretrained:
...
def resnet50(pretrained=False, channel= 20, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], nb_classes=15, channel=channel, **kwargs)
    if pretrained:
...
def resnet101(pretrained=False, channel= 20, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 23, 3],nb_classes=15, channel=channel, **kwargs)
    if pretrained:
